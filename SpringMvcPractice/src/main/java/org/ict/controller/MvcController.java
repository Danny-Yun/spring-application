...
public class MvcController {
	...
	// 원래 파라미터 자료형이 int, String등이었던 경우는 단일 자료형이었기 때문에 get, post방식으로 전달되는 데이터를 자동으로 받아서 처리할 수 있었다. 
	// 현재 TestVO 내부에는 int age, String name이 들어있고 TestVO를 아래와 같이 선언하는 것만으로도 int age, String name을 선언하는 것과
	// 같은 효과를 볼 수 있다. 즉 ?age=000&name=000 라고 적는 데이터를 받아올 수 있다. 
